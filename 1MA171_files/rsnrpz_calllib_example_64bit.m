...
% 64bit MATLAB calllib example for R&S NRPZ Instrument Driver rsnrpz
...
vxipnpLib    = 'rsnrpz_64';
vxipnpLibDll = 'rsnrpz_64.dll';
vxipnpHeader = 'rsnrpz.h';

if ~libisloaded (vxipnpLib)
    %suppress not found functions and types warnings
    warning off MATLAB:loadlibrary:TypeNotFound
    warning off MATLAB:loadlibrary:functionnotfound
    [notfound,warnings]=loadlibrary(vxipnpLibDll, vxipnpHeader, 'includepath', p1, 'includepath', p2, 'addheader', 'rsnrpz.h');
end
