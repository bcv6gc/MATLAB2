...
grid on
figure;
plot(freq,imag(pzt25.epsilon - pzt2_25.epsilon),freq,imag(pzt30.epsilon - pzt2_30.epsilon),...
    freq,imag(pzt35.epsilon - pzt2_35.epsilon),freq,imag(pzt40.epsilon - pzt2_40.epsilon),...
