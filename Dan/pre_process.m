...
%@@@ file handling assumes you are in the running code in same folder that 
...
pt_21=filter_sii_gaussian_8001_plot(s21_t,c21,3000);

pa_12=filter_sii_gaussian_8001_plot(s12_a,c12,3000);
pt_12=filter_sii_gaussian_8001_plot(s12_t,c12,3000);
