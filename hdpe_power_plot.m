...
figure;
plot(hdpe20.t_frequency/1e9,real(hdpe20.epsilont),hdpe20.frequency/1e9,...
...
ylim([0 4])
figure;
plot(hdpe20.t_frequency/1e9,imag(hdpe20.epsilont),hdpe20.frequency/1e9,imag(hdpe20.epsilon),hdpe25.frequency/1e9,imag(hdpe25.epsilon),...
